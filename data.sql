...
CREATE TABLE `auction` (
  ...
  CONSTRAINT `fk_shipper_id` FOREIGN KEY (`shipper_id`) REFERENCES `shipper` (`shipper_id`)
...
CREATE TABLE `customer` (
  ...
  CONSTRAINT `fk_user_customer` FOREIGN KEY (`customer_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `promotion` (
  ...
  CONSTRAINT `fk_admin_created` FOREIGN KEY (`created_by`) REFERENCES `sys_admin` (`admin_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reported_order` (
  ...
  CONSTRAINT `fk_admin_assigned` FOREIGN KEY (`assigned_to`) REFERENCES `sys_admin` (`admin_id`),
  CONSTRAINT `fk_reported_order_id` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `review` (
  ...
  `rate` float NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_reviewed_order` FOREIGN KEY (`id`) REFERENCES `order` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shipper` (
  ...
  CONSTRAINT `fk_admin_id` FOREIGN KEY (`approved_by`) REFERENCES `sys_admin` (`admin_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_user_shipper` FOREIGN KEY (`shipper_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_admin` (
  ...
  CONSTRAINT `fk_user_admin` FOREIGN KEY (`admin_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-06 17:00:42
